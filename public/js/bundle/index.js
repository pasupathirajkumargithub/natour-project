...
})({"i5p9B":[function(require,module,exports) {
...
if (signupForm) signupForm.addEventListener("submit", (e)=>{
    ...
    (0, _signup.signup)(name, mail, password, passwordConfirm);
});
...
if (userDataForm) userDataForm.addEventListener("submit", function(e) {
    ...
    (0, _updateData.updateSettings)(form, "data");
});
if (userPaswordForm) userPaswordForm.addEventListener("submit", function(e) {
    e.preventDefault();
    document.querySelector(".btn-save--password").textContent = "Updating...";
    const passwordCurrent = document.getElementById("password-current").value;
    const password = document.getElementById("password").value;
    const passwordConfirm = document.getElementById("password-confirm").value;
    (0, _updateData.updateSettings)({
        passwordCurrent,
        password,
        passwordConfirm
    }, "password");
...
if (bookBtn) bookBtn.addEventListener("click", async function(e) {
    console.log("button clicked");
    e.target.textContent = "Processing..!";
    const tourID = e.target.dataset.tourId;
    console.log(tourID);
    const data = await (0, _stripe.bookTour)(tourID);
    window.location.href = `${data.session.url}`;
});

},{"@babel/polyfill":"dTCHC","./mapBox":"k6XpQ","./login":"7yHem","./signup":"fNY2o","./updateData":"85FCu","./stripe":"10tSC"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoibXVydWdhMjAwNSIsImEiOiJjbHBpNWM5dTYwNjNxMmtwamc3M2pocXFpIn0.PHYPaX6BrTxK4nL4_PqFpw";
...
const logout = async ()=>{
    try {
        ...
        console.log(error);
        (0, _alert.showAlert)("error", "Error loging out plerse try again ! ");
    }
};
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const signup = async (name, mail, password, passwordConfirm)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "POST",
...
},{"axios":"jo6P5","./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"85FCu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
...
const bookTour = async (tourID)=>{
    try {
        const response = await fetch(`http://127.0.0.1:3000/api/v1/booking/checkout-session/${tourID}`);
        if (!response.ok) throw new Error(`Failed to fetch checkout session: ${response.status}`);
        const session = await response.json();
        (0, _alert.showAlert)("success", "Payment is processing..!");
        return session;
    } catch (error) {
...
},{"./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["i5p9B","f2QDv"], "f2QDv", "parcelRequire11c7")
